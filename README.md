...
| [Docker Container Hardening Lab](https://github.com/ThiagoMicki1/docker-container-hardening-lab) | Insecure-versus-hardened container builds with Trivy scanning, SBOM generation, validation scripts, and tests. |
